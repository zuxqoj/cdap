...
export const ActionConfig = [
  ...
  },
  {
    ...
    title: T.translate(`${PREFIX}.Administrations.title`).toString(),
    description: T.translate(`${PREFIX}.Administrations.description`).toString(),
    links: [
      {
        label: T.translate(`${PREFIX}.Administrations.systemLabel`).toString(),
        url: '/cdap/administration',
      },
      {
        label: T.translate(`${PREFIX}.Administrations.namespaceLabel`).toString(),
